                      ...
                      <div class="flex gap-2 justify-between text-xs">
                        <div class="flex items-center gap-1 truncate">
                          <template v-if="item.restaurant.name">
                            <svg v-if="item.restaurant.location" height="14px"  class="z-10" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M20.3939 10.697C20.3939 18.2391 10.697 24.7037 10.697 24.7037C10.697 24.7037 1 18.2391 1 10.697C1 5.34148 5.34148 1 10.697 1C16.0525 1 20.3939 5.34148 20.3939 10.697Z" fill="#05203C" stroke="#05203C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6972 13.9292C12.4823 13.9292 13.9295 12.4821 13.9295 10.6969C13.9295 8.91176 12.4823 7.4646 10.6972 7.4646C8.912 7.4646 7.46484 8.91176 7.46484 10.6969C7.46484 12.4821 8.912 13.9292 10.6972 13.9292Z" fill="white" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>

                            <svg v-else class="md:h-4 h-3 shrink-0" viewBox="0 0 12 16" fill="none"
