  ...
  <div class="location-slider relative md:h-full md:w-full w-auto md:max-w-full max-w-[300px] mx-auto z-0">
    ...
    <div class="swiper md:h-full">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide md:block flex flex-col justify-end py-2">
          <div class="relative text-white pt-8 text-center text-sm font-bold cursor-pointer" @click="goToSlide(0)">
